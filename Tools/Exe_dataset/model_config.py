...
model_configs = {
        'head_model': {
            'indices': HEAD_ORIGINAL_INDICES,
            'keypoint_names': HEAD_KEYPOINT_NAMES,
            'bone_connections': HEAD_BONE_CONNECTIONS,
            'label_key': 'head'
        },
        'hand_model': {
            'indices': HAND_ORIGINAL_INDICES,
            'keypoint_names': HAND_KEYPOINT_NAMES,
            'bone_connections': HAND_BONE_CONNECTIONS,
            'label_key': 'hand'
        },
        'foot_model': {
            'indices': FOOT_ORIGINAL_INDICES,
            'keypoint_names': FOOT_KEYPOINT_NAMES,
            'bone_connections': FOOT_BONE_CONNECTIONS,
            'label_key': 'feet'
        },
        'torso_model': {
            'indices': TORSO_ORIGINAL_INDICES,
            'keypoint_names': TORSO_KEYPOINT_NAMES,
            'bone_connections': TORSO_BONE_CONNECTIONS,
            'label_key': 'body'
        },
        'arm_model': {
            'indices': ARM_ORIGINAL_INDICES,
            'keypoint_names': ARM_KEYPOINT_NAMES,
            'bone_connections': ARM_BONE_CONNECTIONS,
            'label_key': 'arm'
        }
    }